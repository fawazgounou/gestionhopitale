		...
		if($passe==$passeC){
			...
			if($compt==0){
				...
				if(!empty($file_name)){
					...
					if(move_uploaded_file($file_tmp_name, $file_dest)){  //on aurait pu vérifier que $_files['fichier']['eror']==0
...
<style type="text/css">
	#ff{
		background-image: url("assets/images/body5.jpg");
		color:white;
	}
</style>
<div id="ff">
	
<div class="contact-form" style="padding-left: 3em; padding-bottom: 3em; padding-right: 3em; border: red; background-color: rgba(255,255,255,0.2); ">
	<div class="py-2 text-center" style="/*background: rgba(0,0,190,1);*/">
	    <h1 style="color: #00008B; font-size: 2.3em; font-family: Algerian; ">CREER UN COMPTE POUR VOTRE PHARMACIE</h1>
	</div>
		...
		<div class="row">
			<div class="col-md-5 order-md-2 mb-4" style="margin-left: 5em; padding-top: 2em;">
			    <div style="border: 1px solid #CECECE; padding: 1em;">
				    ...
				    <span class="text-muted"><b>Pour vous connecter</b></span>
				    </h4>
				    <div class="mb-3">
	    	...
	    	<div class="col-md-6 order-md-1">
			    <div class="row">
			        <div class="col-md-6 mb-3">
				        <label for="nomhopital">NOM DE LA PHARMACIE</label>
					    <input type="text" class="form-control" name ="nom" id="nomhopital" placeholder="nom de votre hopital" value="<?php if(isset($_POST['nom'])){echo $_POST['nom'];} ?>" required>
				    </div>
				<div class="col-md-6 mb-3">
					<label for="description">PRESENTATION/DESCRIPTION</label>
					<br>
					<textarea name="description" class="form-control" id="description" placeholder="quelques détails sur votre pharmacie..." value="<?php if(isset($_POST['description'])){ echo $_POST['description'];} ?>" required></textarea>  	
				</div>
		        </div>
			    ...
			    <div class="row">
					...
					<div class="col-md-6 mb-3">
				    	<label for="situ_geo"> SITUATION GEOGRAPHIQUE</label>
				  		<br>
				  		<textarea name="situ_geo" class="form-control" id="situ_geo" value="<?php if(isset($_POST['situ_geo'])){ echo $_POST['situ_geo'] ;} ?>" placeholder="plus d'indications sur votre emplacement dans la ville" ></textarea>
					</div>
